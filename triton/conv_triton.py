...
def triton_tem_fused_convolution_0(arg_X, arg_W, out_ptr0):
    ...
    for ijk in range(KERNEL_H * KERNEL_W * BLOCK_K_COUNT):
        ...
        # Gather the input for corresponding filter (duplicated)
        x_ptrs = x_base + (
...
#''', device_str='cuda')
#meta0 = {'KERNEL_H': 3, 'KERNEL_W': 3, 'STRIDE_H': 1, 'STRIDE_W': 1, 'PADDING_H': 1, 'PADDING_W': 1, 'GROUPS': 1, 'UNROLL': False, 'ALLOW_TF32': True, 'BLOCK_M': 128, 'BLOCK_N': 128, 'BLOCK_K': 32, 'matrix_instr_nonkdim': 0}
