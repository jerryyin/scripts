...
define amdgpu_kernel void @repro(ptr addrspace(1) inreg writeonly captures(none) %0, float inreg %1, ptr addrspace(1) inreg readnone captures(none) %2, ptr addrspace(1) inreg readnone captures(none) %3) local_unnamed_addr #0 !dbg !4 {
  ...
  %210 = shl nuw nsw i32 %189, 2, !dbg !36
  %211 = lshr i32 %6, 5, !dbg !36
  %212 = and i32 %211, 4, !dbg !36
  %213 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %210, !dbg !36
  %214 = getelementptr inbounds nuw i8, ptr addrspace(3) %213, i32 %212, !dbg !36
  %215 = getelementptr inbounds nuw i8, ptr addrspace(3) %214, i32 %201, !dbg !36
  %216 = insertelement <1 x float> poison, float %186, i64 0, !dbg !36
  store <1 x float> %216, ptr addrspace(3) %215, align 4, !dbg !36
  tail call void @llvm.amdgcn.s.waitcnt(i32 49279), !dbg !36
  tail call void @llvm.amdgcn.s.barrier(), !dbg !36
  %217 = and i32 %5, 15, !dbg !36
  %218 = shl nuw nsw i32 %217, 3, !dbg !36
  %219 = shl nuw nsw i32 %11, 1, !dbg !36
  %220 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %218, !dbg !36
  %221 = getelementptr inbounds nuw i8, ptr addrspace(3) %220, i32 %219, !dbg !36
  %222 = load <2 x float>, ptr addrspace(3) %221, align 8, !dbg !36
  %223 = extractelement <2 x float> %222, i64 0, !dbg !36
  %224 = extractelement <2 x float> %222, i64 1, !dbg !36
  %225 = fmul float %223, 0.000000e+00, !dbg !37
  %226 = fmul float %224, 0.000000e+00, !dbg !37
  tail call void @llvm.amdgcn.s.waitcnt(i32 49279), !dbg !13
  tail call void @llvm.amdgcn.s.barrier(), !dbg !13
  %227 = shl nuw nsw i32 %13, 1, !dbg !13
  %228 = select i1 %203, i32 0, i32 1056, !dbg !13
  %229 = or disjoint i32 %11, %227, !dbg !13
  %230 = xor i32 %229, %228, !dbg !13
  %231 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %230, !dbg !13
  %232 = shufflevector <2 x float> %157, <2 x float> poison, <1 x i32> zeroinitializer, !dbg !13
  %233 = fptrunc <1 x float> %232 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %233, ptr addrspace(3) %231, align 2, !dbg !13
  %234 = getelementptr inbounds nuw i8, ptr addrspace(3) %231, i32 4096, !dbg !13
  %235 = shufflevector <2 x float> %165, <2 x float> poison, <1 x i32> zeroinitializer, !dbg !13
  %236 = fptrunc <1 x float> %235 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %236, ptr addrspace(3) %234, align 2, !dbg !13
  %237 = xor i32 %230, 264, !dbg !13
  %238 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %237, !dbg !13
  %239 = shufflevector <2 x float> %158, <2 x float> poison, <1 x i32> <i32 1>, !dbg !13
  %240 = fptrunc <1 x float> %239 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %240, ptr addrspace(3) %238, align 2, !dbg !13
  %241 = getelementptr inbounds nuw i8, ptr addrspace(3) %238, i32 4096, !dbg !13
  %242 = shufflevector <2 x float> %166, <2 x float> poison, <1 x i32> <i32 1>, !dbg !13
  %243 = fptrunc <1 x float> %242 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %243, ptr addrspace(3) %241, align 2, !dbg !13
  %244 = xor i32 %230, 528, !dbg !13
  %245 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %244, !dbg !13
  %246 = shufflevector <2 x float> %159, <2 x float> poison, <1 x i32> zeroinitializer, !dbg !13
  %247 = fptrunc <1 x float> %246 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %247, ptr addrspace(3) %245, align 2, !dbg !13
  %248 = getelementptr inbounds nuw i8, ptr addrspace(3) %245, i32 4096, !dbg !13
  %249 = shufflevector <2 x float> %167, <2 x float> poison, <1 x i32> zeroinitializer, !dbg !13
  %250 = fptrunc <1 x float> %249 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %250, ptr addrspace(3) %248, align 2, !dbg !13
  %251 = xor i32 %230, 792, !dbg !13
  %252 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %251, !dbg !13
  %253 = shufflevector <2 x float> %160, <2 x float> poison, <1 x i32> <i32 1>, !dbg !13
  %254 = fptrunc <1 x float> %253 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %254, ptr addrspace(3) %252, align 2, !dbg !13
  %255 = getelementptr inbounds nuw i8, ptr addrspace(3) %252, i32 4096, !dbg !13
  %256 = shufflevector <2 x float> %168, <2 x float> poison, <1 x i32> <i32 1>, !dbg !13
  %257 = fptrunc <1 x float> %256 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %257, ptr addrspace(3) %255, align 2, !dbg !13
  %258 = xor i32 %230, 2112, !dbg !13
  %259 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %258, !dbg !13
  %260 = shufflevector <2 x float> %161, <2 x float> poison, <1 x i32> zeroinitializer, !dbg !13
  %261 = fptrunc <1 x float> %260 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %261, ptr addrspace(3) %259, align 2, !dbg !13
  %262 = getelementptr inbounds nuw i8, ptr addrspace(3) %259, i32 4096, !dbg !13
  %263 = shufflevector <2 x float> %169, <2 x float> poison, <1 x i32> zeroinitializer, !dbg !13
  %264 = fptrunc <1 x float> %263 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %264, ptr addrspace(3) %262, align 2, !dbg !13
  %265 = xor i32 %230, 2376, !dbg !13
  %266 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %265, !dbg !13
  %267 = shufflevector <2 x float> %162, <2 x float> poison, <1 x i32> <i32 1>, !dbg !13
  %268 = fptrunc <1 x float> %267 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %268, ptr addrspace(3) %266, align 2, !dbg !13
  %269 = getelementptr inbounds nuw i8, ptr addrspace(3) %266, i32 4096, !dbg !13
  %270 = shufflevector <2 x float> %170, <2 x float> poison, <1 x i32> <i32 1>, !dbg !13
  %271 = fptrunc <1 x float> %270 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %271, ptr addrspace(3) %269, align 2, !dbg !13
  %272 = xor i32 %230, 2640, !dbg !13
  %273 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %272, !dbg !13
  %274 = shufflevector <2 x float> %163, <2 x float> poison, <1 x i32> zeroinitializer, !dbg !13
  %275 = fptrunc <1 x float> %274 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %275, ptr addrspace(3) %273, align 2, !dbg !13
  %276 = getelementptr inbounds nuw i8, ptr addrspace(3) %273, i32 4096, !dbg !13
  %277 = shufflevector <2 x float> %171, <2 x float> poison, <1 x i32> zeroinitializer, !dbg !13
  %278 = fptrunc <1 x float> %277 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %278, ptr addrspace(3) %276, align 2, !dbg !13
  %279 = xor i32 %230, 2904, !dbg !13
  %280 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %279, !dbg !13
  %281 = shufflevector <2 x float> %164, <2 x float> poison, <1 x i32> <i32 1>, !dbg !13
  %282 = fptrunc <1 x float> %281 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %282, ptr addrspace(3) %280, align 2, !dbg !13
  %283 = getelementptr inbounds nuw i8, ptr addrspace(3) %280, i32 4096, !dbg !13
  %284 = shufflevector <2 x float> %172, <2 x float> poison, <1 x i32> <i32 1>, !dbg !13
  %285 = fptrunc <1 x float> %284 to <1 x bfloat>, !dbg !13
  store <1 x bfloat> %285, ptr addrspace(3) %283, align 2, !dbg !13
  tail call void @llvm.amdgcn.s.waitcnt(i32 49279), !dbg !38
  tail call void @llvm.amdgcn.s.barrier(), !dbg !38
  %286 = and i32 %5, 60, !dbg !38
  %287 = shl nuw nsw i32 %286, 6, !dbg !38
  %288 = shl nuw nsw i32 %5, 3, !dbg !38
  %289 = and i32 %288, 24, !dbg !38
  %290 = shl nuw nsw i32 %286, 1, !dbg !38
  %291 = or disjoint i32 %287, %289, !dbg !38
  %292 = xor i32 %291, %290, !dbg !38
  %293 = extractelement <2 x i32> %14, i64 0, !dbg !38
  %294 = xor i32 %292, %293, !dbg !38
  %295 = getelementptr inbounds nuw i8, ptr addrspace(3) @global_smem, i32 %294, !dbg !38
  %296 = tail call <4 x bfloat> @llvm.amdgcn.ds.read.tr16.b64.v4bf16(ptr addrspace(3) %295), !dbg !38
  %297 = getelementptr inbounds nuw i8, ptr addrspace(3) %295, i32 4096, !dbg !38
  %298 = tail call <4 x bfloat> @llvm.amdgcn.ds.read.tr16.b64.v4bf16(ptr addrspace(3) nonnull %297), !dbg !38
  %299 = getelementptr inbounds nuw i8, ptr addrspace(3) %295, i32 128, !dbg !38
  %300 = tail call <4 x bfloat> @llvm.amdgcn.ds.read.tr16.b64.v4bf16(ptr addrspace(3) nonnull %299), !dbg !38
  %301 = getelementptr inbounds nuw i8, ptr addrspace(3) %295, i32 4224, !dbg !38
  %302 = tail call <4 x bfloat> @llvm.amdgcn.ds.read.tr16.b64.v4bf16(ptr addrspace(3) nonnull %301), !dbg !38
  %303 = shufflevector <4 x bfloat> %296, <4 x bfloat> %298, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>, !dbg !39
  %304 = shufflevector <4 x bfloat> %300, <4 x bfloat> %302, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>, !dbg !39
  %305 = shufflevector <4 x bfloat> %207, <4 x bfloat> %209, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>, !dbg !39
  %306 = insertelement <4 x float> poison, float %225, i64 0, !dbg !39
  %307 = shufflevector <4 x float> %306, <4 x float> poison, <4 x i32> zeroinitializer, !dbg !39
  %308 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.bf16(<8 x bfloat> %305, <8 x bfloat> %303, <4 x float> %307, i32 0, i32 0, i32 0), !dbg !39
  %309 = insertelement <4 x float> poison, float %226, i64 0, !dbg !39
  %310 = shufflevector <4 x float> %309, <4 x float> poison, <4 x i32> zeroinitializer, !dbg !39
  %311 = tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x32.bf16(<8 x bfloat> %305, <8 x bfloat> %304, <4 x float> %310, i32 0, i32 0, i32 0), !dbg !39
  tail call void @llvm.amdgcn.s.waitcnt(i32 49279), !dbg !40
  tail call void @llvm.amdgcn.s.barrier(), !dbg !40
  store <1 x float> %216, ptr addrspace(3) %215, align 4, !dbg !40
  tail call void @llvm.amdgcn.s.waitcnt(i32 49279), !dbg !40
  tail call void @llvm.amdgcn.s.barrier(), !dbg !40
  %312 = load <2 x float>, ptr addrspace(3) %221, align 8, !dbg !40
  %313 = fadd float %186, %186, !dbg !41
  %314 = fdiv float 1.000000e+00, %313, !dbg !42
  tail call void @llvm.amdgcn.s.waitcnt(i32 49279), !dbg !43
  tail call void @llvm.amdgcn.s.barrier(), !dbg !43
  %315 = insertelement <1 x float> poison, float %314, i64 0, !dbg !43
  store <1 x float> %315, ptr addrspace(3) %215, align 4, !dbg !43
  tail call void @llvm.amdgcn.s.waitcnt(i32 49279), !dbg !43
  tail call void @llvm.amdgcn.s.barrier(), !dbg !43
  %316 = load <2 x float>, ptr addrspace(3) %221, align 8, !dbg !43
  %317 = shufflevector <4 x float> %308, <4 x float> poison, <2 x i32> <i32 0, i32 1>, !dbg !44
  %318 = shufflevector <2 x float> %312, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !44
  %319 = fmul <2 x float> %317, %318, !dbg !44
  %320 = shufflevector <2 x float> %316, <2 x float> poison, <2 x i32> zeroinitializer, !dbg !45
  %321 = fmul <2 x float> %319, %320, !dbg !45
  %322 = shufflevector <4 x float> %308, <4 x float> poison, <2 x i32> <i32 2, i32 3>, !dbg !44
  %323 = fmul <2 x float> %322, %318, !dbg !44
  %324 = fmul <2 x float> %323, %320, !dbg !45
  %325 = shufflevector <4 x float> %311, <4 x float> poison, <2 x i32> <i32 0, i32 1>, !dbg !44
  %326 = shufflevector <2 x float> %312, <2 x float> poison, <2 x i32> <i32 1, i32 1>, !dbg !44
  %327 = fmul <2 x float> %325, %326, !dbg !44
  %328 = shufflevector <2 x float> %316, <2 x float> poison, <2 x i32> <i32 1, i32 1>, !dbg !45
  %329 = fmul <2 x float> %327, %328, !dbg !45
  %330 = shufflevector <4 x float> %311, <4 x float> poison, <2 x i32> <i32 2, i32 3>, !dbg !44
  %331 = fmul <2 x float> %330, %326, !dbg !44
  %332 = fmul <2 x float> %331, %328, !dbg !45
  %333 = fptrunc <2 x float> %321 to <2 x bfloat>, !dbg !46
  %334 = fptrunc <2 x float> %324 to <2 x bfloat>, !dbg !46
  %335 = fptrunc <2 x float> %329 to <2 x bfloat>, !dbg !46
  %336 = fptrunc <2 x float> %332 to <2 x bfloat>, !dbg !46
  %337 = load <2 x bfloat>, ptr addrspace(3) %193, align 4, !dbg !47
  %338 = lshr exact i32 %11, 2, !dbg !48
  %339 = or disjoint i32 %338, %217, !dbg !48
  %340 = lshr i32 %5, 2, !dbg !49
  %341 = and i32 %340, 12, !dbg !49
  %342 = shl nuw nsw i32 %339, 4, !dbg !50
  %343 = or disjoint i32 %342, %341, !dbg !51
  %344 = zext nneg i32 %343 to i64, !dbg !52
  %345 = getelementptr [2 x i8], ptr addrspace(1) %0, i64 %344, !dbg !52
  %346 = getelementptr i8, ptr addrspace(1) %345, i64 2048, !dbg !52
  %347 = shufflevector <2 x bfloat> %333, <2 x bfloat> %334, <4 x i32> <i32 0, i32 1, i32 2, i32 3>, !dbg !53
  store <4 x bfloat> %347, ptr addrspace(1) %345, align 8, !dbg !53
  %348 = shufflevector <2 x bfloat> %335, <2 x bfloat> %336, <4 x i32> <i32 0, i32 1, i32 2, i32 3>, !dbg !53
  store <4 x bfloat> %348, ptr addrspace(1) %346, align 8, !dbg !53
  %349 = shl nuw nsw i32 %5, 6, !dbg !54
  %350 = and i32 %349, 448, !dbg !54
  %351 = lshr i32 %12, 3, !dbg !11
  %352 = or disjoint i32 %351, %350, !dbg !55
  %353 = zext nneg i32 %352 to i64, !dbg !56
  %354 = getelementptr [2 x i8], ptr addrspace(1) %0, i64 %353, !dbg !56
  %355 = getelementptr i8, ptr addrspace(1) %354, i64 4096, !dbg !56
  %356 = getelementptr i8, ptr addrspace(1) %354, i64 4160, !dbg !56
  %357 = shufflevector <2 x bfloat> %337, <2 x bfloat> poison, <1 x i32> zeroinitializer, !dbg !10
  store <1 x bfloat> %357, ptr addrspace(1) %355, align 2, !dbg !10
  %358 = shufflevector <2 x bfloat> %337, <2 x bfloat> poison, <1 x i32> <i32 1>, !dbg !10
  store <1 x bfloat> %358, ptr addrspace(1) %356, align 2, !dbg !10
  ret void, !dbg !57
}
...
!1 = !DIFile(filename: "micro-dot.ttgir", directory: "/root/scripts/triton/reproducers/amdgpu_ds_read_b64_waitcnt/ir")
