...
.Ltmp58:
	...
	s_add_i32 s57, 0, 0x3840
	s_add_i32 s52, 0, 0x3c40
	s_add_i32 s58, 0, 0x2c40
	s_add_i32 s53, 0, 0x3040
	s_add_i32 s59, 0, 0x2000
	s_add_i32 s54, 0, 0x2420
...
.Ltmp64:
	.loc	1 36 18 is_stmt 0               ; mha.py:36:18 @[ mha.py:140:13 @[ mha.py:746:25 ] ]
	s_lshl_b32 s52, s61, 10
.Ltmp65:
	.loc	1 36 18                         ; mha.py:36:18 @[ mha.py:150:17 @[ mha.py:746:25 ] ]
	v_add_u32_e32 v38, s53, v39
	s_lshl_b32 s53, s61, 5
.Ltmp66:
	.loc	1 36 18                         ; mha.py:36:18 @[ mha.py:140:13 @[ mha.py:746:25 ] ]
	s_add_i32 s54, s52, 0
...
.Ltmp99:
	...
	ds_write_b16 v68, v15 offset:4096
	ds_write_b16 v69, v57
	ds_write_b16 v69, v8 offset:4096
	ds_write_b16 v70, v86
	ds_write_b16 v70, v9 offset:4096
	ds_write_b16 v71, v4
	ds_write_b16 v71, v12 offset:4096
	ds_write_b16 v72, v5
	ds_write_b16 v72, v13 offset:4096
	ds_write_b16 v73, v6
	ds_write_b16 v73, v10 offset:4096
	ds_write_b16 v74, v7
	ds_write_b16 v74, v11 offset:4096
	s_waitcnt lgkmcnt(0)
	s_barrier
...
.Ltmp163:
	...
	v_xor_b32_e32 v9, 0x108, v6
	v_xor_b32_e32 v10, 0x210, v6
	v_xor_b32_e32 v11, 0x318, v6
	v_xor_b32_e32 v12, 0x840, v6
	v_xor_b32_e32 v13, 0x948, v6
	v_xor_b32_e32 v14, 0xa50, v6
	v_xor_b32_e32 v15, 0xb58, v6
...
.Lfunc_end0:
	...
	.set _attn_fwd_IS_CAUSAL_0_NUM_Q_HEADS_32_NUM_K_HEADS_4_BLOCK_M_128_BLOCK_N_32_BLOCK_DMODEL_16_RETURN_SCORES_0_ENABLE_DROPOUT_0_IS_FP8_0_VARLEN_0_NUM_XCD_8_USE_INT64_STRIDES_1_ENABLE_SINK_0_SLIDING_WINDOW_0.numbered_sgpr, 64
