...
.Ltmp1:
	...
	.loc	1 65 5                          ; micro-dot.ttgir:65:5
	v_bitop3_b32 v2, v2, s1, v3 bitop3:0x6c
	.loc	1 63 5                          ; micro-dot.ttgir:63:5
	s_and_b32 s0, s5, 64
	...
	.loc	1 65 5 is_stmt 1                ; micro-dot.ttgir:65:5
	ds_write_b32 v2, v6 offset:2048
	...
	ds_read_b64_tr_b16 v[20:21], v3 offset:4224
	ds_read_b64_tr_b16 v[18:19], v3 offset:128
	.loc	1 77 12                         ; micro-dot.ttgir:77:12
	...
	.loc	1 129 5                         ; micro-dot.ttgir:129:5
	ds_read_b32 v14, v23 offset:8192
	.loc	1 83 12                         ; micro-dot.ttgir:83:12
	v_mfma_f32_16x16x32_bf16 v[6:9], v[30:33], v[18:21], v[6:9]
	...
	.loc	1 87 15                         ; micro-dot.ttgir:87:15
	s_nop 0
	v_pk_mul_f32 v[6:7], v[6:7], v[10:11] op_sel:[0,1]
	.loc	1 94 17                         ; micro-dot.ttgir:94:17
	v_cvt_pk_bf16_f32 v3, v4, v5
	.loc	1 93 19                         ; micro-dot.ttgir:93:19
	v_pk_mul_f32 v[6:7], v[6:7], v[12:13] op_sel:[0,1]
	...
	global_store_short_d16_hi v[0:1], v14, off offset:64
