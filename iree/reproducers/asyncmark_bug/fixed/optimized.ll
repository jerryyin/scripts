...
85:                                               ; preds = %3, %85
  ...
  ; [REMOVED] asyncmark
  tail call void @llvm.amdgcn.s.waitcnt(i32 8184) ; vmcnt(8) [was wait.asyncmark(2) x 4 loads/group]
  fence syncscope("workgroup") release, !mmra !3
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire, !mmra !3
...
577:                                              ; preds = %85
  ...
  tail call void @llvm.amdgcn.s.waitcnt(i32 8176) ; vmcnt(0) [wait for all]
  fence syncscope("workgroup") release, !mmra !3
  tail call void @llvm.amdgcn.s.barrier()
  fence syncscope("workgroup") acquire, !mmra !3
...
; Function Attrs: alwaysinline nounwind
; [REMOVED] declare void @llvm.amdgcn.asyncmark() #5

; Function Attrs: alwaysinline nounwind
; [REMOVED] declare void @llvm.amdgcn.wait.asyncmark(i16 immarg) #5
